...
//     setRules([...rules, {
//       id: Date.now(), icon: "⚙️", label: customLabel,
//       toggleVal: true, color: "#6c63ff", type: "toggle",
//     }]);
...
//             <input type="text" placeholder="Saisissez le libellé de la règle..."
...
//             <Plus size={14}/> Créer une règle personnalisée
//           </button>
//         )}
...
//   const [saved,       setSaved]      = useState(false); // feedback visuel
...
//   // Charge la liste des moniteurs depuis Electron/MySQL
//   useEffect(() => {
...
//   const handleSave = () => {
//     updatePermissions(selectedId, localPerms); // → contexte + localStorage
//     setSaved(true);
//     // Petite pause pour montrer le feedback, puis fermer
...
//         {isAdding ? (
//           <div style={{ marginTop: 15, padding: 12, background: "#f8faff", borderRadius: 10, border: "1px dashed #6c63ff" }}>
//             <input type="text" placeholder="Libellé de la nouvelle règle..."
//               value={customLabel} onChange={e => setCustomLabel(e.target.value)}
//               style={{ width: "100%", padding: "8px", borderRadius: "6px", border: "1px solid #ccc", marginBottom: "10px", outline: "none" }}
//               autoFocus />
//             <div style={{ display: "flex", gap: 10 }}>
