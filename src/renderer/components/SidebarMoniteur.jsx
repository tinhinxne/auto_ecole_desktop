  ...
  return (
    <div style={{
      ...
      <button
        ...
        onMouseEnter={e => { e.currentTarget.style.background = "#4da3ff"; e.currentTarget.style.borderColor = "#4da3ff"; e.currentTarget.querySelector("svg").style.stroke = "white"; }}
        onMouseLeave={e => { e.currentTarget.style.background = "white"; e.currentTarget.style.borderColor = "#1e293b"; e.currentTarget.querySelector("svg").style.stroke = "#1e293b"; }}
      >
        <svg
          viewBox="0 0 10 10"
          style={{
      ...
      <div style={{
        ...
        <nav style={{ flex: 1, display: "flex", flexDirection: "column", overflow: "hidden" }}>
          ...
          {/* Paramètres */}
          <Link to="/moniteur/parametres" style={{ textDecoration: "none", color: "inherit" }}>
            {(() => {
              const isActive = location.pathname === "/moniteur/parametres";
              return (
                <li style={{
                  position: "relative",
                  display: "flex",
